...
public class ViewHistoryActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // startup with the history button already selected
        navigationView.setCheckedItem( R.id.nav_button_history );
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_button_todo) {
            ...
            this.finish();
            Intent intent = new Intent( ViewHistoryActivity.this, ViewStatisticsActivity.class );
